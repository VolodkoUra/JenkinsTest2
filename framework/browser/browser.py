...
class Browser(metaclass=Singleton):
    ...
    def set_up_driver(self, browser_key, capabilities=None, is_incognito=False,
        ...
        self.__web_driver[browser_key] = \
            BrowserFactory.get_browser_driver(browser_name=browser_key, capabilities=capabilities,
    ...
    def select_browser(self, browser_key):
